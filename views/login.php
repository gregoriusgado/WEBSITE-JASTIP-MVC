...
<!-- LOGIN AREA -->
<div class="wrapper">
  <form action="../controller/loginController.php" method="POST" class="login-container">
    <h2>Welcome Back, Titip Lagi Yuk!</h2>

    <?php if(isset($_GET['error'])) echo "<p>Password atau Username salah!</p>"; ?>
    <?php if(isset($_GET['succes'])) echo "<p>Registrasi berhasil, silahkan login!</p>"; ?>
